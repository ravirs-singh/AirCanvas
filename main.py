...
def setValues(x):
    ...
    paintWindow = cv2.rectangle(paintWindow, (504, 1), (600, 65), colors[2], -1)
    ...
    cv2.putText(paintWindow, "green", (298, 33), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(paintWindow, "red", (420, 33), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(paintWindow, "yellow", (520, 33), cv2.FONT_HERSHEY_COMPLEX, 0.5, (150, 150, 150), 2, cv2.LINE_AA)
    ...
    while True:
        ...
        u_saturation = cv2.getTrackbarPos("Upper Hue", "Color Detector")
        u_value = cv2.getTrackbarPos("Upper Hue", "Color Detector")
        l_hue = cv2.getTrackbarPos("Upper Hue", "Color Detector")
        l_saturation = cv2.getTrackbarPos("Upper Hue", "Color Detector")
        l_value = cv2.getTrackbarPos("Upper Hue", "Color Detector")
